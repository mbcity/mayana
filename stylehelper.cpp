...
QString StyleHelper::getToolBarButtonStyleSheet()
{
    return "QToolButton { "
           /*"image: url(:/buttons/play.png);"
           "icon-size: 48px;"
...
QString StyleHelper::getMenuButtonStyleSheet()
{
    return "QToolButton { "
           /*"image: url(:/buttons/play.png);"
           "icon-size: 48px;"
...
QString StyleHelper::getMenuFrameStyleSheet()
{
    return "QFrame {"
        /*"background-color: #2C3E50;"*/
            "background-color: #2C3E50;"
...
QString StyleHelper::getToolBarFrameStyleSheet()
{
    return "QFrame {"
        /*"background-color: #34495E;"*/
            "background-color: #34495E;"
...
QString StyleHelper::getMainFrameStyleSheet()
{
    return "QFrame {"
